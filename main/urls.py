...
from .views import home, partner_view, signup_view, about_view, gallery_view, publication_view, giving_view, events_view, verify_giving_callback, meeting_view, welfare_view
